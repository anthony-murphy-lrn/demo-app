  ...
  try {
    ...
    switch (action) {
      ...
      case 'forceCleanupSession':
        ...
        const success = await SessionCleanupService.forceCleanupSession(data.sessionId);
        
        return NextResponse.json({
          status: 'success',
          message: success ? 'Session force cleaned successfully' : 'Session not found',
          success,
        });
      ...
      case 'testFullCleanupFlow':
        ...
        return NextResponse.json({
          ...
          improvement: {
            ...
            activeSessions: beforeStats.activeSessions - afterStats.activeSessions,
            expiredSessions: beforeStats.expiredSessions - afterStats.expiredSessions,
          }
        });
